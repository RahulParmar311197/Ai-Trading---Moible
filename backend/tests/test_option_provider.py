...
def test_upstox_option_chain_maps_market_data_and_contract_metadata(monkeypatch):
    chain_response = {
        "status": "success",
        "data": [{
            "expiry": "2026-09-24", "strike_price": 25000, "underlying_key": "NSE_INDEX|Nifty 50",
            "call_options": {"instrument_key": "NSE_FO|123", "market_data": {"ltp": 101.0, "volume": 1000, "oi": 5000, "bid_price": 100.0, "ask_price": 102.0}, "option_greeks": {"delta": 0.5, "gamma": 0.01, "theta": -2.0, "vega": 10.0, "iv": 20.0}},
            "put_options": {"instrument_key": "NSE_FO|124", "market_data": {"ltp": 99.0, "volume": 900, "oi": 4000, "bid_price": 98.0, "ask_price": 100.0}, "option_greeks": {"delta": -0.5, "iv": 22.0}},
        }],
    }
    contract_response = {
        "status": "success",
        "data": [
            {"instrument_key": "NSE_FO|123", "trading_symbol": "NIFTY 25000 CE 24 SEP 26", "lot_size": 65, "instrument_type": "CE", "underlying_key": "NSE_INDEX|Nifty 50", "strike_price": 25000, "expiry": "2026-09-24"},
            {"instrument_key": "NSE_FO|124", "trading_symbol": "NIFTY 25000 PE 24 SEP 26", "lot_size": 65, "instrument_type": "PE", "underlying_key": "NSE_INDEX|Nifty 50", "strike_price": 25000, "expiry": "2026-09-24"},
        ],
    }
    ...
    async def fake_get(url, **kwargs):
        ...
        payload = chain_response if url.endswith("/option/chain") else contract_response
...
def test_upstox_option_chain_rejects_missing_contract_metadata(monkeypatch):
    responses = [
        {"status": "success", "data": [{"expiry": "2026-09-24", "strike_price": 25000, "underlying_key": "NSE_INDEX|Nifty 50", "call_options": {"instrument_key": "NSE_FO|123", "market_data": {}, "option_greeks": {}}}]},
        {"status": "success", "data": []},
    ]
    async def fake_get(url, **kwargs):
